...
//
// Select cells to perform this operation. Modify the string inside the quotation marks on line 22 to any text you would like to insert to the selected cells.
